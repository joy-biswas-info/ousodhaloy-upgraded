            ...
            <div class="bg-white rounded-xl border p-5">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="price" id="field-price" step="0.01"
                            value="{{ old('price', $product?->price) }}"
                            class="form-input" required placeholder="10.80"
                            oninput="calcDiscount()">
                    </div>
                    <div>
                        <label class="form-label">MRP / Unit Price (৳)</label>
                        <input type="number" name="mrp" id="field-mrp" step="0.01"
                            value="{{ old('mrp', $product?->mrp) }}"
                            class="form-input" placeholder="12.00"
                            oninput="calcDiscount()">
                    </div>
                    <div>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl border p-5">
                ...
                <div id="gallery-wrap" class="flex flex-wrap gap-2 mb-3">
                    ...
                    @endforeach
                    <button type="button" onclick="pickGalleryImage()"
...
{{-- ── Scripts inline so Alpine finds productForm() before processing x-data ── --}}
<script>
