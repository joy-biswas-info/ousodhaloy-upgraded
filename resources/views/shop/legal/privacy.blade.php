...
@section('title', 'Privacy Policy – ' . \App\Models\Setting::get('site_name'))
@section('meta_description', 'Read the privacy policy for ' . \App\Models\Setting::get('site_name') . '. Learn how we
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-2xl border shadow-sm p-6 sm:p-8">
            ...
            <div class="prose max-w-none">
                ...
                <p>{{ $site }} ("we", "us", or "our") is committed to protecting your personal information. This
                ...
                <p>You have the right to access, correct, or delete your personal data. To exercise these rights or ask
                    questions about this policy, contact us at <a href="mailto:{{ $email }}">{{ $email }}</a>.
                </p>
