    ...
    <div style="position:relative;min-height:240px;height:{{ $heroH }}px;max-height:{{ $heroH }}px;">
        ...
        <div style="position:absolute;inset:0;background:linear-gradient(135deg,var(--teal-dark),var(--teal-light));display:flex;align-items:center;padding:0 32px">
            <div style="color:#fff;max-width:480px">
                ...
                <p style="font-size:14px;opacity:.85;margin-bottom:16px">৳{{ \App\Models\Setting::get('free_delivery_min',500) }}+ অর্ডারে ফ্রি হোম ডেলিভারি</p>
                <a href="{{ route('shop.index') }}" style="display:inline-flex;align-items:center;gap:8px;background:#fff;color:var(--teal-dark);font-weight:700;font-size:13px;padding:10px 22px;border-radius:10px;text-decoration:none">
