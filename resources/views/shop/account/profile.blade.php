                ...
                <div class="flex items-center gap-4 mb-5 pb-4 border-b">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-1 mt-1">
                            ...
                            <span class="text-xs font-semibold text-gray-600">{{ number_format(auth()->user()->total_loyalty_points) }} Loyalty Points</span>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="#" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ auth()->user()->phone }}" class="form-input bg-gray-50" readonly>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="email" name="email" value="{{ auth()->user()->email }}" class="form-input" placeholder="Optional">
                        </div>
                    </div>
