...
─────────────────────────────
Usage: @include('partials.media-picker', ['pickerId' => 'unique-id'])

JS API (global):
openMediaPicker(pickerId, callback)
callback(path, url, filename) — called when user selects an image

Example:
openMediaPicker('thumb', (path, url) => {
document.getElementById('thumbnail-path').value = path;
