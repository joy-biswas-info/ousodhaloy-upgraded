...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <tr x-data="{ editing: false }">
                        ...
                        <td>
                            <div class="flex gap-1.5" x-show="!editing">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.brands.update', $brand)); ?>" x-show="false" x-ref="toggleForm">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="name" value="<?php echo e($brand->name); ?>">
                                    <input type="hidden" name="is_active" :value="<?php echo e($brand->is_active ? 'false' : 'true'); ?>">
                                </form>
                            ...
                            <form x-show="editing" method="POST" action="<?php echo e(route('admin.brands.update', $brand)); ?>" class="flex gap-2">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <input type="text" name="name" value="<?php echo e($brand->name); ?>" class="form-input" style="width:140px">
                                <input type="text" name="country" value="<?php echo e($brand->country); ?>" class="form-input" style="width:100px" placeholder="Country">
    ...
    <div class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.brands.store')); ?>" enctype="multipart/form-data" class="space-y-3">
            <?php echo csrf_field(); ?>
            <div>
