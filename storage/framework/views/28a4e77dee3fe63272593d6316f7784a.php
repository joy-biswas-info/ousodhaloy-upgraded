...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            <div class="space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [['route' => 'account.profile', 'icon' => 'user-cog', 'label' => 'Profile'], ['route' => 'account.orders', 'icon' => 'box', 'label' => 'My Orders'], ['route' => 'account.wishlist', 'icon' => 'heart', 'label' => 'Wishlist'], ['route' => 'account.addresses', 'icon' => 'map-marker', 'label' => 'Addresses']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="sm:col-span-3 space-y-4">
                <div class="bg-white rounded-2xl border p-5">
                    ...
                    <form method="POST" action="<?php echo e(route('account.profile.update')); ?>" class="space-y-4"> <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e(auth()->user()->phone); ?>" class="form-input bg-gray-50"
                                    readonly>
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="email" name="email" value="<?php echo e(auth()->user()->email); ?>" class="form-input"
