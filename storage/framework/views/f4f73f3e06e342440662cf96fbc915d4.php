    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --accent-bright: color-mix(in srgb, <?php echo e($accent); ?> 82%, black);
            --accent-glow: color-mix(in srgb, <?php echo e($accent); ?> 35%, white);
            --cta: <?php echo e($cta); ?>;
            --cta-bright: color-mix(in srgb, <?php echo e($cta); ?> 82%, black);
            --ink: #2B2220;
            --muted: #55483F;
            --muted2: #A6938D;
            --danger: #C2486A;
...
<body>
    ...
    <section class="hero">
        <div class="hero-img-wrap">
            <img src="<?php echo e($metaImage); ?>" alt="<?php echo e($product->name); ?>" width="370" height="370" loading="eager"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($product->rating_count ?? 0) > 0): ?>
            <div class="fbadge f2">
                <div class="fbadge-icon" style="background: color-mix(in srgb, var(--accent) 14%, transparent)">★</div>
                <div><div class="fbadge-t"><?php echo e(number_format($product->average_rating, 1)); ?>/5 Rating</div><div class="fbadge-s"><?php echo e($product->rating_count); ?>+ রিভিউ</div></div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </section>
    ...
    <section class="price-section" id="order">
        <div class="price-card">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->badge_text): ?>
            <div class="sale-badge"><?php echo e($landingPage->badge_text); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="price-row">
                <div class="price-now">৳<?php echo e(number_format($price, 0)); ?></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comparePrice): ?>
                <div class="price-was">৳<?php echo e(number_format($comparePrice, 0)); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="price-save"><?php echo e($discountPercent); ?>% OFF</div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->countdown_end_at): ?>
            <div class="countdown">
            ...
            <div id="order-form-wrap">
                <div class="qty-row">
                    ...
                    <span class="qty-subtotal" id="qty-subtotal-txt">৳<?php echo e(number_format($price, 0)); ?></span>
                </div>
                ...
                <form class="order-form" id="order-form" novalidate>
                    ...
                    <div class="of-pay">
                        ...
                        <label><input type="radio" name="payment_method" value="ssl_commerz" <?php echo e(!$codEnabled ? 'checked' : ''); ?>><span>💳 Card/bKash/Nagad</span></label>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="order-totals">
                        ...
                        <strong>Total: ৳<span id="total-amt"><?php echo e(number_format($price, 0)); ?></span></strong>
                    </div>
                </form>
            </div>
            ...
            <p class="ship-note"><?php echo e($landingPage->shipping_note ?: 'ডেলিভারি ২৪–৪৮ ঘণ্টার মধ্যে পৌঁছাবে।'); ?></p>
            ...
            <div style="text-align:center">
                <a href="<?php echo e($messengerUrl); ?>" target="_blank" class="messenger-link">
            ...
            <div class="caution-box">
                ...
                <?php echo e($landingPage->return_policy_note ?: 'পণ্য রিটার্ন করতে চাইলে অবশ্যই ডেলিভারি ম্যানের সামনে প্যাকেট খুলে চেক করতে হবে।'); ?>

            </div>
        </div>
    </section>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->sectionEnabled('trust_badges') && count($landingPage->section('trust_badges')['items'] ?? [])): ?>
    <div class="trust-pills">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $landingPage->section('trust_badges')['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="tpill"><?php echo e($badge); ?></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <section class="hero">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->eyebrow_text): ?>
        <div class="eyebrow"><div class="blink"></div><?php echo e($landingPage->eyebrow_text); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <h1 class="hero-h1"><?php echo e($landingPage->headline); ?></h1>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->subheadline): ?>
        <p class="hero-sub"><?php echo e($landingPage->subheadline); ?></p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($landingPage->sectionEnabled('problems') && count($landingPage->section('problems')['items'] ?? [])): ?>
        <div class="problems">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $landingPage->section('problems')['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="prob"><?php echo e($prob['icon'] ?? ''); ?> <?php echo e($prob['text'] ?? ''); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </section>
    ...
    <section class="sec" style="background: radial-gradient(ellipse 60% 50% at 50% 100%, color-mix(in srgb, var(--accent) 7%, transparent) 0%, transparent 70%);">
        ...
        <div class="grid-cards">
            ...
            <div class="g-card">
                <div class="g-icon"><?php echo e($f['icon'] ?? '✨'); ?></div>
                <div class="g-title"><?php echo e($f['title_en'] ?? ''); ?></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($f['tag'])): ?><div class="g-tag"><?php echo e($f['tag']); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="g-desc"><?php echo e($f['desc'] ?? ''); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </section>
    ...
    <section class="sec" style="padding-top: 8px">
        ...
        <div class="benefit-list">
            ...
            <div class="benefit">
                <div class="b-icon"><?php echo e($b['icon'] ?? '✨'); ?></div>
                <div>
                    <div class="b-title"><?php echo e($b['title_en'] ?? ''); ?></div>
                    <div class="b-desc"><?php echo e($b['desc'] ?? ''); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <section class="sec" style="padding-top: 0">
        ...
        <div class="how-grid">
            ...
            <div class="how-card">
                <div class="how-num"><?php echo e($i + 1); ?></div>
                <div class="how-title"><?php echo e($h['title_en'] ?? ''); ?></div>
                <div class="how-desc"><?php echo e($h['desc'] ?? ''); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </section>
    ...
    <section class="sec" style="padding-top: 0">
        ...
        <div class="reviews">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="review">
                <div class="rev-stars"><?php echo e(str_repeat('★', $r->rating)); ?><?php echo e(str_repeat('☆', 5 - $r->rating)); ?></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->body): ?><div class="rev-body">"<?php echo e($r->body); ?>"</div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="rev-author">
                    <div class="rev-av"><?php echo e(strtoupper(substr($r->display_name, 0, 1))); ?></div>
                    <div class="rev-name"><?php echo e($r->display_name); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <div class="vstrip">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $landingPage->section('trust_badges')['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="vi"><?php echo e($badge); ?></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <section class="sec">
        ...
        <div class="faq-list">
            ...
            <div class="faq-item">
                <button class="faq-q" type="button"><?php echo e($faq['q'] ?? ''); ?> <span class="ico">+</span></button>
    ...
    <section class="final-cta">
        <h2>আজই অর্ডার করুন <em><?php echo e($product->name); ?></em></h2>
        <p><?php echo e($landingPage->subheadline ?: 'সীমিত স্টক, সীমিত সময়ের অফার।'); ?></p>
        <a href="#order" class="final-cta-btn">⚡ মাত্র ৳<?php echo e(number_format($price, 0)); ?> — Order Now</a>
    </section>

    <footer>
        <p>© <?php echo e(date('Y')); ?> Ousodhaloy.com · Bangladesh</p>
        <div class="footer-links">
            <a href="<?php echo e(route('legal.privacy')); ?>">Privacy Policy</a>
            <a href="<?php echo e(route('legal.terms')); ?>">Terms of Use</a>
            <a href="<?php echo e(route('legal.returns')); ?>">Return Policy</a>
        </div>
    </footer>

    <div class="sticky-bar" id="sticky">
        <div class="s-info">
            <div class="s-name"><?php echo e(Str::limit($product->name, 30)); ?></div>
            <div class="s-price">৳<?php echo e(number_format($price, 0)); ?></div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <?php if($landingPage->countdown_end_at): ?>
        var end = new Date("<?php echo e($landingPage->countdown_end_at->toIso8601String()); ?>").getTime();
        function tick() {
        ...
        // ── ViewContent pixel ──
        <?php if($pixelViewContent): ?>
        if (window.fbTrack) {
            window.fbTrack('ViewContent', {
                content_ids: ['<?php echo e($product->id); ?>'], content_name: <?php echo json_encode($product->name, 15, 512) ?>,
                content_type: 'product', value: <?php echo e($price); ?>, currency: 'BDT'
            });
        }
        <?php endif; ?>
    });
    ...
    var qty = 1;
    var unitPrice = <?php echo e($price); ?>;
    var BD_DISTRICTS = <?php echo json_encode(config('bd.districts', []), 512) ?>;
    var landingSlug = <?php echo json_encode($landingPage->slug, 15, 512) ?>;
        ...
        try {
            ...
            if (window.fbTrack) {
                window.fbTrack('Purchase', {
                    content_ids: ['<?php echo e($product->id); ?>'], content_type: 'product',
...
<?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/shop/landingpage/dynamic.blade.php ENDPATH**/ ?>