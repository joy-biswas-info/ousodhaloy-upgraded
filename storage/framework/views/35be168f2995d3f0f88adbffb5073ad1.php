<?php $__env->startSection('title', 'Terms of Use – ' . \App\Models\Setting::get('site_name')); ?>
<?php $__env->startSection('meta_description', 'Read the terms and conditions for using ' . \App\Models\Setting::get('site_name') . ' —
        ...
        <div class="bg-white rounded-2xl border shadow-sm p-6 sm:p-8">
            ...
            <div class="prose max-w-none">
                ...
                <p>You are responsible for keeping your login credentials secure. Do not share your account with others.
                    <?php echo e($site); ?> is not liable for losses resulting from unauthorised use of your account. Notify us
                ...
                <p>We deliver across Bangladesh via partnered courier services. Delivery times are estimates only and are
                    not guaranteed. <?php echo e($site); ?> is not responsible for delays caused by couriers, natural events, or
                    circumstances beyond our control.</p>

                <h2>7. Returns and Refunds</h2>
                <p>Please review our separate <a href="<?php echo e(route('legal.returns')); ?>">Return Policy</a> for full details on
                ...
                <p>All content on this website — including logos, product images, text, and design — is the property of
                    <?php echo e($site); ?> or its licensors. You may not reproduce or redistribute content without written
                    permission.</p>

                <h2>10. Limitation of Liability</h2>
                <p>To the fullest extent permitted by law, <?php echo e($site); ?> is not liable for any indirect, incidental,
                ...
                <p>For questions about these terms, contact us at <a
                        href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a> or call <a
                        href="tel:<?php echo e($phone); ?>"><?php echo e($phone); ?></a>.</p>
...
<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/shop/legal/terms.blade.php ENDPATH**/ ?>