...
<div id="cookie-banner"
    ...
    <div style="max-width:900px;margin:0 auto;display:flex;align-items:center;
        ...
        <p style="flex:1;min-width:220px;font-size:13px;color:#374151;line-height:1.5;margin:0;">
            ...
            By using <strong><?php echo e(\App\Models\Setting::get('site_name', 'Ousodhaloy')); ?></strong> you agree to our
            <a href="<?php echo e(route('legal.privacy')); ?>"
                style="color:var(--teal);font-weight:600;text-decoration:underline;">Privacy Policy</a>
            and
            <a href="<?php echo e(route('legal.terms')); ?>"
...
<?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/partials/cookie-banner.blade.php ENDPATH**/ ?>