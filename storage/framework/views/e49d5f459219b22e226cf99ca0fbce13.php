            ...
            <div class="bg-white rounded-2xl shadow-lg border overflow-hidden" x-data="forgotForm()">
                ...
                <div class="p-7 space-y-5">
                    ...
                    <div x-show="step === 2">
                        ...
                        <form method="POST" action="<?php echo e(route('auth.forgot.reset')); ?>" class="space-y-4">
                            <?php echo csrf_field(); ?>
        ...
        function forgotForm() {
            return {
                ...
                async sendOtp() {
                    ...
                    this.loading = true;
                    this.message = '';
                    const res = await fetch('<?php echo e(route('auth.forgot.send')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>