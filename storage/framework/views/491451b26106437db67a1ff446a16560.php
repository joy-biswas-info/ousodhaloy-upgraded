        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-lg border overflow-hidden">
                ...
                <div class="p-7 space-y-4">
                    ...
                    <form method="POST" action="<?php echo e(route('auth.login.post')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label class="form-label">Email or Phone</label>
                            <input type="text" name="login" value="<?php echo e(old('login')); ?>" class="form-input"
                        ...
                        <div class="flex justify-between items-center text-xs">
                            ...
                            <a href="<?php echo e(route('auth.forgot')); ?>" class="text-teal-700 hover:underline font-semibold">Forgot
                                password?</a>
                        </div>
                        <button type="submit" class="btn-primary w-full py-3">Sign In</button>
                    </form>
                    <div class="text-center">
                        <a href="<?php echo e(route('auth.otp')); ?>" class="text-xs text-teal-700 hover:underline font-semibold">
                            <i class="fas fa-mobile-alt mr-1"></i>Login with OTP (Phone)
                        </a>
                    </div>
                    <div class="text-center text-sm text-gray-600">
                        Don't have an account?
                        <a href="<?php echo e(route('auth.register')); ?>" class="text-teal-700 font-semibold hover:underline">Sign
                            Up</a>
                    </div>
                </div>
            </div>
            <p class="text-center text-xs text-gray-400 mt-4">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-teal-700">← Back to Store</a>
            </p>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>