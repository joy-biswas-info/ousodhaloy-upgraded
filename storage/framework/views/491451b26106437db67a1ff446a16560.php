            ...
            <div class="p-7 space-y-4">
                ...
                <form method="POST" action="<?php echo e(route('auth.login.post')); ?>" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="login" value="<?php echo e(old('login')); ?>" class="form-input" placeholder="email@example.com or 01XXXXXXXXX" required autofocus>
                    </div>
                    <div>
                ...
                <div class="text-center text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('auth.register')); ?>" class="text-teal-700 font-semibold hover:underline">Sign Up</a>
                </div>
            </div>
        </div>
