...
<div class="space-y-5" x-data="{ tab: '<?php echo e(request('tab','general')); ?>' }">
    ...
    <div x-show="tab === 'general'" class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="form-label">Site Name</label><input type="text" name="site_name" value="<?php echo e($settings['site_name'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Tagline</label><input type="text" name="site_tagline" value="<?php echo e($settings['site_tagline'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Phone</label><input type="text" name="site_phone" value="<?php echo e($settings['site_phone'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Email</label><input type="email" name="site_email" value="<?php echo e($settings['site_email'] ?? ''); ?>" class="form-input"></div>
                <div class="col-span-2"><label class="form-label">Address</label><input type="text" name="site_address" value="<?php echo e($settings['site_address'] ?? ''); ?>" class="form-input"></div>
                <div>
                    ...
                    <img src="<?php echo e(asset('storage/'.$settings['site_logo'])); ?>" class="h-12 mb-2 rounded border">
    ...
    <div x-show="tab === 'orders'" class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="space-y-4 mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="form-label">Default Delivery Charge (৳)</label><input type="number" name="delivery_charge" value="<?php echo e($settings['delivery_charge'] ?? 60); ?>" class="form-input"></div>
                <div><label class="form-label">Free Delivery Above (৳)</label><input type="number" name="free_delivery_min" value="<?php echo e($settings['free_delivery_min'] ?? 500); ?>" class="form-input"></div>
            </div>
            <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="guest_checkout" value="true" <?php echo e(($settings['guest_checkout'] ?? '') === 'true' ? 'checked' : ''); ?> class="accent-teal-600">
        ...
        <div class="border-t pt-5">
                    ...
                    <tbody>
                        ...
                        <tr x-data="{ editing: false }">
                            ...
                            <td>
                                ...
                                <form x-show="editing" method="POST" action="<?php echo e(route('admin.settings.delivery-zones.update', $zone)); ?>" class="flex gap-1 flex-wrap items-center">
                                    ...
                                    <input type="number" name="delivery_charge" value="<?php echo e($zone->delivery_charge); ?>" step="0.01" class="form-input py-1 text-xs" style="width:80px">
                                    <input type="number" name="free_delivery_above" value="<?php echo e($zone->free_delivery_above); ?>" step="0.01" class="form-input py-1 text-xs" style="width:80px">
                                    <input type="number" name="estimated_days" value="<?php echo e($zone->estimated_days); ?>" class="form-input py-1 text-xs" style="width:55px">
                            ...
                            <td><span class="text-xs font-semibold <?php echo e($zone->is_active ? 'text-green-600' : 'text-gray-400'); ?>"><?php echo e($zone->is_active ? 'Active' : 'Off'); ?></span></td>
                            <td x-show="!editing">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.delivery-zones.store')); ?>" class="grid grid-cols-3 gap-3">
                <?php echo csrf_field(); ?>
                <input type="text" name="name" placeholder="Zone name (e.g. Dhaka City)" class="form-input" required>
                <select name="division" class="form-select" required>
                    <option value="">Division</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = config('bd.divisions'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $div): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($div); ?>"><?php echo e($div); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
    ...
    <div x-show="tab === 'payment'" class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="space-y-5">
            ...
            <div class="border-t pt-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div><label class="form-label">Store ID</label><input type="text" name="ssl_store_id" value="<?php echo e($settings['ssl_store_id'] ?? ''); ?>" class="form-input"></div>
                    <div><label class="form-label">Store Password</label><input type="password" name="ssl_store_pass" value="<?php echo e($settings['ssl_store_pass'] ?? ''); ?>" class="form-input"></div>
                </div>
                <label class="flex items-center gap-2 cursor-pointer mt-3">
                    <input type="checkbox" name="ssl_is_live" value="true" <?php echo e(($settings['ssl_is_live'] ?? '') === 'true' ? 'checked' : ''); ?> class="accent-teal-600">
            ...
            <div class="overflow-x-auto">
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alwaysField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-gray-50">
                            <td class="text-sm font-medium text-gray-700"><?php echo e($alwaysField); ?> <span class="text-xs text-teal-600">(always required)</span></td>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <input type="checkbox" name="checkout_field[<?php echo e($f['key']); ?>][visible]" value="1"
                                    <?php echo e($visible ? 'checked' : ''); ?> class="accent-teal-600">
                            </td>
                            <td class="text-center">
                                <input type="checkbox" name="checkout_field[<?php echo e($f['key']); ?>][required]" value="1"
                                    <?php echo e($required ? 'checked' : ''); ?> class="accent-teal-600">
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
    ...
    <div x-show="tab === 'sms'" class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="form-label">API Key</label><input type="text" name="mimsms_api_key" value="<?php echo e($settings['mimsms_api_key'] ?? ''); ?>" class="form-input" placeholder="From app.mimsms.com"></div>
                <div><label class="form-label">Sender ID</label><input type="text" name="mimsms_sender_id" value="<?php echo e($settings['mimsms_sender_id'] ?? 'Ousodhaloy'); ?>" class="form-input"></div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['sms_order_confirm'=>'SMS on Order Placed','sms_status_update'=>'SMS on Status Update']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="<?php echo e($key); ?>" value="true" <?php echo e(($settings[$key] ?? '') === 'true' ? 'checked' : ''); ?> class="accent-teal-600">
    ...
    <div x-show="tab === 'pathao'" class="bg-white rounded-xl border p-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="form-label">Client ID</label><input type="text" name="pathao_client_id" value="<?php echo e($settings['pathao_client_id'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Client Secret</label><input type="password" name="pathao_client_secret" value="<?php echo e($settings['pathao_client_secret'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Username</label><input type="text" name="pathao_username" value="<?php echo e($settings['pathao_username'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Password</label><input type="password" name="pathao_password" value="<?php echo e($settings['pathao_password'] ?? ''); ?>" class="form-input"></div>
                <div><label class="form-label">Store ID</label><input type="text" name="pathao_store_id" value="<?php echo e($settings['pathao_store_id'] ?? ''); ?>" class="form-input"></div>
            </div>
            <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="pathao_is_live" value="true" <?php echo e(($settings['pathao_is_live'] ?? '') === 'true' ? 'checked' : ''); ?> class="accent-teal-600">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="number" name="pathao_default_city_id"
                            value="<?php echo e($settings['pathao_default_city_id'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="pathao_default_zone_id"
                            value="<?php echo e($settings['pathao_default_zone_id'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="pathao_default_area_id"
                            value="<?php echo e($settings['pathao_default_area_id'] ?? ''); ?>"
    ...
    <div x-show="tab === 'steadfast'" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="steadfast_api_key"
                            value="<?php echo e($settings['steadfast_api_key'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="password" name="steadfast_secret_key"
                            value="<?php echo e($settings['steadfast_secret_key'] ?? ''); ?>"
                            class="form-input"
        ...
        <div class="bg-white rounded-xl border p-5">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2 <?php echo e(($settings['steadfast_enabled'] ?? '') === 'true' ? 'bg-green-50 border-green-200 text-green-700' : 'bg-gray-50 border-gray-200 text-gray-500'); ?> border rounded-xl px-4 py-2.5">
                    <span class="text-lg"><?php echo e(($settings['steadfast_enabled'] ?? '') === 'true' ? '🟢' : '⚫'); ?></span>
                    <div>
                        <p class="text-xs font-bold">Steadfast</p>
                        <p class="text-sm font-black"><?php echo e(($settings['steadfast_enabled'] ?? '') === 'true' ? 'Enabled' : 'Disabled'); ?></p>
                    </div>
                </div>
    ...
    <div x-show="tab === 'pixel'" class="space-y-4">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.pixel')); ?>" class="space-y-5">
                ...
                <div class="p-4 bg-gray-50 rounded-xl">
                    ...
                    <div class="flex gap-3">
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="meta_pixel_mode" value="<?php echo e($mode); ?>" <?php echo e(($settings['meta_pixel_mode'] ?? 'test') === $mode ? 'checked' : ''); ?> class="sr-only peer">
                            <div class="border-2 rounded-xl p-3 text-center text-sm font-bold transition-all peer-checked:border-teal-500 peer-checked:bg-teal-50 <?php echo e($mclass); ?>">
                                <?php echo e($mlabel); ?>
                    ...
                    <div class="mt-3" id="test-code-wrap" x-data x-show="<?php echo e(($settings['meta_pixel_mode'] ?? 'test') === 'test' ? 'true' : 'false'); ?>">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="meta_access_token" value="<?php echo e($settings['meta_access_token'] ?? ''); ?>"
        ...
        <div class="bg-white rounded-xl border p-5">
            ...
            <div class="flex flex-wrap gap-3">
                <div class="flex items-center gap-2 bg-<?php echo e(($settings['meta_pixel_mode'] ?? '') === 'live' ? 'green' : 'yellow'); ?>-50 border border-<?php echo e(($settings['meta_pixel_mode'] ?? '') === 'live' ? 'green' : 'yellow'); ?>-200 rounded-xl px-4 py-2.5">
                    <span class="text-lg"><?php echo e(($settings['meta_pixel_mode'] ?? '') === 'live' ? '🟢' : '🧪'); ?></span>
                    <div>
                        <p class="text-xs font-bold">Mode</p>
                        <p class="text-sm font-black"><?php echo e(strtoupper($settings['meta_pixel_mode'] ?? 'test')); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-mono font-black"><?php echo e($settings['meta_pixel_test_event_code']); ?></p>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
