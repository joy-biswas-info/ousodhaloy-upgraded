<?php $__env->startSection('page-title', 'Bulk Add Products'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-5" x-data="bulkProducts()">
        ...
        <div x-show="tab==='form'">
            <form method="POST" action="<?php echo e(route('admin.products.bulk-store')); ?>" id="bulk-form">
                <?php echo csrf_field(); ?>
            ...
            <datalist id="brand-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($b->name); ?>"><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </datalist>
            <datalist id="category-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($c->name); ?>"><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </datalist>
            <datalist id="form-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Tablet', 'Capsule', 'Syrup', 'Cream', 'Ointment', 'Injection', 'Eye Drop', 'Ear Drop', 'Inhaler', 'Suspension', 'Powder', 'Gel', 'Spray', 'Patch', 'Suppository']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-white rounded-xl border p-5">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.products.import-csv')); ?>" enctype="multipart/form-data"
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="<?php echo e(route('admin.products.csv-template')); ?>" class="btn-outline flex-1 text-center">
...
<div id="media-picker-modal" class="fixed inset-0 bg-black/60 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[80vh] flex flex-col">
        ...
        <div class="p-3 border-t flex justify-between items-center">
            <a href="<?php echo e(route('admin.media.index')); ?>" target="_blank"
    ...
    <script>
        ...
        function loadMediaPicker(query) {
            ...
            _debounce = setTimeout(async () => {
                ...
                if (!data.length) {
                    grid.innerHTML = '<div class="col-span-6 text-center text-gray-400 py-8">No images found. <a href="<?php echo e(route('admin.media.index')); ?>" target="_blank" class="text-teal-600 underline">Upload some →</a></div>';
                    return;
                }
