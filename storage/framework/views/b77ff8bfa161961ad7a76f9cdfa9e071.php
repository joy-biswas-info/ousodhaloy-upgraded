            ...
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    <tr x-data="{ editing: false }">
                        ...
                        <td>
                            <span x-show="!editing" class="font-semibold text-sm text-gray-800"><?php echo e($cat->name); ?></span>
                            <form x-show="editing" method="POST" action="<?php echo e(route('admin.categories.update', $cat)); ?>" class="flex gap-2">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <input type="text" name="name" value="<?php echo e($cat->name); ?>" class="form-input" style="width:140px">
                                <input type="text" name="icon" value="<?php echo e($cat->icon); ?>" class="form-input" style="width:50px" maxlength="5">
                                <input type="number" name="sort_order" value="<?php echo e($cat->sort_order); ?>" class="form-input" style="width:60px">
                                <input type="hidden" name="is_active" value="<?php echo e($cat->is_active ? 'true' : 'false'); ?>">
                        ...
                        <td>
                            <span class="text-xs font-semibold <?php echo e($cat->is_active ? 'text-green-600' : 'text-gray-400'); ?>">
                        ...
                        <td>
                            <div class="flex gap-1.5">
                                ...
                                <a href="<?php echo e(route('shop.index', ['category' => $cat->slug])); ?>" target="_blank" class="btn-outline btn-sm">
    ...
    <div class="bg-white rounded-xl border p-5">
        ...
        <div class="mt-5 pt-5 border-t">
            ...
            <div class="flex flex-wrap gap-1.5">
                ...
                <span class="text-xs bg-gray-100 px-2 py-1 rounded cursor-pointer hover:bg-teal-50" onclick="document.querySelector('[name=name]').value='<?php echo e(explode(' ',trim($c),2)[1] ?? $c); ?>'; document.querySelector('[name=icon]').value='<?php echo e(substr(trim($c),0,2)); ?>'"><?php echo e($c); ?></span>
