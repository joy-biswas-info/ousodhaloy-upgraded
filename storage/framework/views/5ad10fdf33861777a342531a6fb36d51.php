            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->rating_count > 0): ?>
                <div class="flex items-center gap-2">
                    <span class="text-2xl font-black"
                        ...
                        <?php echo e($product->average_rating); ?>
        ...
        <div class="px-5 pb-5">
            ...
            <div class="pt-5 mt-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <form method="POST"
                        action="<?php echo e(route('shop.product.review', $product->slug)); ?>"
                        class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex gap-1"
                                x-data="{ rating: <?php echo e(old('rating', 0)); ?>, hover: 0 }">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($s = 1; $s <= 5; $s++): ?>
                                    <button type="button"
                                        @click="rating = <?php echo e($s); ?>"
                                        @mouseenter="hover = <?php echo e($s); ?>"
                                        @mouseleave="hover = 0"
                                        class="text-2xl leading-none focus:outline-none">

                                        <i class="fas fa-star"
                                            :class="(hover || rating) >= <?php echo e($s); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea name="body"
                                ...
                                class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-50 resize-none"><?php echo e(old('body')); ?></textarea>
...
</div><?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/shop/partials/review-card.blade.php ENDPATH**/ ?>