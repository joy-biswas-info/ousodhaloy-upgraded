...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> – <?php echo e(\App\Models\Setting::get('site_name', 'Ousodhaloy')); ?> Admin</title>
    ...
    <aside class="fixed left-0 top-0 h-full w-64 bg-gray-900 z-50 flex flex-col transition-transform duration-300"
        ...
        <div class="p-5 border-b border-gray-800 flex items-center justify-between">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2">
                ...
                <div>
                    <p class="text-white font-bold text-sm"><?php echo e(\App\Models\Setting::get('site_name', 'Ousodhaloy')); ?>
        ...
        <nav class="flex-1 p-3 overflow-y-auto space-y-0.5">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route($item['route'])); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['badge']) && $item['badge'] > 0): ?>
                        <span
                            class="bg-red-500 text-white text-[10px] font-bold rounded-full px-1.5 py-0.5 min-w-[18px] text-center"><?php echo e($item['badge']); ?></span>
    ...
    <div class="lg:ml-64 min-h-screen flex flex-col">
        ...
        <header class="bg-white border-b shadow-sm h-14 flex items-center justify-between px-5 sticky top-0 z-40">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-base font-bold text-gray-800"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                    <p class="text-xs text-gray-400 hidden sm:block"><?php echo $__env->yieldContent('breadcrumb', 'Admin Panel'); ?></p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingCount > 0): ?>
                        <span
                            class="absolute -top-1 -right-1 bg-red-500 text-white text-[9px] font-bold rounded-full w-4 h-4 flex items-center justify-center"><?php echo e($pendingCount); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                <span class="text-xs text-gray-400"><?php echo e(now()->format('D, d M Y')); ?></span>
            </div>
        </header>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div
                ...
                <i class="fas fa-check-circle text-green-600"></i> <?php echo e(session('success')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
            <div
                ...
                <i class="fas fa-exclamation-circle text-red-600"></i> <?php echo e(session('error')); ?>

            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <main class="flex-1 p-5"><?php echo $__env->yieldContent('content'); ?></main>

        <footer class="border-t py-3 px-5 text-center text-xs text-gray-400">
            <?php echo e(\App\Models\Setting::get('site_name', 'Ousodhaloy')); ?> Admin v1.0 &middot; <?php echo e(now()->year); ?>
...
</html><?php /**PATH /Users/joybiswas/Downloads/ousodhaloy-laravel/resources/views/layouts/admin.blade.php ENDPATH**/ ?>